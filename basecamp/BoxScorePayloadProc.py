...
from basecamp.BoxScoreParse import parse_game, check_totals
...
#SELECT_RAW = "SELECT game_pk, payload FROM boxscore_raw WHERE game_pk = ANY(%s)"
...
def main() -> int:
    ...
    with closing(connect()) as conn:
            ...
            print(f"\n{totals['batting']} batting rows, {totals['pitching']} pitching rows, " f"{totals['failed']} game(s) not loaded")
