...
\restrict XyzdzqUMV9RVLepk1fbozeiuL5vcmqOylStvlzI4FQ3H6UAphwmXFWy7r89yefN
...
--
-- Name: dim_players; Type: TABLE; Schema: public; Owner: postgres
--
...
ALTER TABLE public.dim_players OWNER TO postgres;

--
-- Name: roster_snapshots; Type: TABLE; Schema: public; Owner: postgres
--
...
--
-- Name: dim_players dim_players_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: roster_snapshots roster_snapshots_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--
...
\unrestrict XyzdzqUMV9RVLepk1fbozeiuL5vcmqOylStvlzI4FQ3H6UAphwmXFWy7r89yefN
